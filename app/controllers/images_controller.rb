...
if File.exists?('public/data/800-' + imagefile)
    path = 'public/data/'
    File.delete('public/data/800-' + imagefile)
    File.delete('public/data/tn-s-c-150-' + imagefile)
    File.delete('public/data/tn-s-g-150-' + imagefile) 
    end
end
